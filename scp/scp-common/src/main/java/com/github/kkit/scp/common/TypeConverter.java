...
public class TypeConverter {
    ...
    public static String shortToHexString(short number){
        return bytesToHexString(shortToByte(number));
    }
    ...
    public static short hexStringToShort(String str){
        return byteToShort(hexStringToByteArray(str));
    }
...
//        if (CollectionUtils.isEmpty(hexStrs)) {
//            return null;
//        }
...
//        if (CollectionUtils.isEmpty(lgs)) {
//            return null;
//        }
