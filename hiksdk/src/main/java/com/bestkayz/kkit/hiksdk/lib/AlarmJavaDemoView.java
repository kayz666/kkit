package com.bestkayz.kkit.hiksdk.lib;//package com.ykzl.yuncard.v2.protocol.gateway.application.hikvision.biz.lib;
//
///**
// * @author: Kayz
// * @create: 2021-01-14
...
//                            strACSInfo.struAcsEventInfo.byCardType + "，报警主类型：0x" + Integer.toHexString(strACSInfo.dwMajor) +
//                            "，报警次类型：0x" + Integer.toHexString(strACSInfo.dwMinor);
//
//                    //设备报警时间
//                    String strAcsTime = "" + String.format("%04d", strACSInfo.struTime.dwYear) +
//                            String.format("%02d", strACSInfo.struTime.dwMonth) +
//                            String.format("%02d", strACSInfo.struTime.dwDay) +
//                            String.format("%02d", strACSInfo.struTime.dwHour) +
//                            String.format("%02d", strACSInfo.struTime.dwMinute) +
//                            String.format("%02d", strACSInfo.struTime.dwSecond);
//                    sAlarmType = sAlarmType + "，报警时间：" + strAcsTime;
//
...
//                            new String(strIDCardInfo.struIDCardCfg.byName).trim() + "，报警主类型：0x" + Integer.toHexString(strIDCardInfo.dwMajor)
//                            + "，报警次类型：0x" + Integer.toHexString(strIDCardInfo.dwMinor);
//
//                    //设备报警时间
//                    String strIDTime = "" + String.format("%04d", strIDCardInfo.struSwipeTime.wYear) +
//                            String.format("%02d", strIDCardInfo.struSwipeTime.byMonth) +
//                            String.format("%02d", strIDCardInfo.struSwipeTime.byDay) +
//                            String.format("%02d", strIDCardInfo.struSwipeTime.byHour) +
//                            String.format("%02d", strIDCardInfo.struSwipeTime.byMinute) +
//                            String.format("%02d", strIDCardInfo.struSwipeTime.bySecond) +
//                            String.format("%03d", strIDCardInfo.struSwipeTime.wMilliSec);
//
//                    sAlarmType = sAlarmType + "，刷卡时间：" + strIDTime;
//
//                    if(strIDCardInfo.byIDCardInfoExtend == 1)
//                    {
//                        HCNetSDK.NET_DVR_ID_CARD_INFO_EXTEND struCardInfoEx = new HCNetSDK.NET_DVR_ID_CARD_INFO_EXTEND();
//                        struCardInfoEx.write();
//                        Pointer pCardInfoEx = struCardInfoEx.getPointer();
//                        pCardInfoEx.write(0, strIDCardInfo.pIDCardInfoExtend.getByteArray(0, struCardInfoEx.size()), 0, struCardInfoEx.size());
//                        struCardInfoEx.read();
//                        sAlarmType = sAlarmType + ", 温度:" + struCardInfoEx.fCurrTemperature + ", 是否异常:" + struCardInfoEx.byIsAbnomalTemperature;
//                    }
//
//                    newRow[0] = dateFormat.format(today);
//                    //报警类型
